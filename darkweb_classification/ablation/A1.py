...
class TaxonomyBuilder:
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "batch_size": 40,
            "request_delay": 1,
            "taxonomy_batch_size": 5000,
            "max_taxonomy_updates": 1,
    ...
    def classify_all_documents(self, taxonomy: List[Dict]):
        ...
        self.export_to_json(all_docs, output_path="output/full_taxonomy_results-1.json")
...
def main():
    ...
    try:
        analyzer.run_analysis(sample_size_for_taxonomy=2500)
