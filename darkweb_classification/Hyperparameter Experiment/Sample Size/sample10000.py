...
class TaxonomyBuilder:
    ...
    def classify_all_documents(self, taxonomy: List[Dict]):
        ...
        self.export_to_json(all_docs, output_path="output/full_taxonomy_results10000_all.json")
...
def main():
    ...
    try:
        analyzer.run_analysis(sample_size_for_taxonomy=10000)
